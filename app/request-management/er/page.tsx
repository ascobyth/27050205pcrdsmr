...
export default function ERRequestManagementPage() {
  ...
  const fetchRequests = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/requests/manage?status=${encodeURIComponent(statusFilter)}&priority=${priorityFilter}&capability=${capabilityFilter}&type=er&search=${encodeURIComponent(searchQuery)}&page=${currentPage}&limit=${pageSize}`
      )
  ...
  useEffect(() => {
    fetchRequests()
    fetchStatusCounts()
  }, [statusFilter, priorityFilter, capabilityFilter, currentPage, pageSize])
